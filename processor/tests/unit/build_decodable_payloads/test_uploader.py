...
def test_upload_main_hk_payloads_posts_expected_payload(monkeypatch):
    ...
    inserted = uploader.upload_main_hk_payloads("http://127.0.0.1:8000", "110000", df, "Kyutech")
...
def test_upload_adcs_hk_payloads_posts_expected_payload(monkeypatch):
    ...
    inserted = uploader.upload_adcs_hk_payloads("http://127.0.0.1:8000", "011000", df, "ISAS")
...
def test_payload_from_df_builds_upload_payload():
    ...
    assert uploader.payload_from_df("001000", df, "Kyutech") == {
        "packet_id": "001000",
        "gse": "Kyutech",
        "rows": [{"Received time": "received", "Data": "aa"}],
    }
